<!-- Auto-generated from shop-details.html -->
<template>
            ...
            <div class="row gx-60 gy-60">
                ...
                <div class="col-xl-6">
                    <div class="product-about">
                        ...
                        <p class="price"><del>€29.50</del>€20.50</p>
                        <p class="text">Our tees are carefully cut and sewn by hand in Los Angeles,  California and enzyme washed for added softness. The tees are garment  dyed which creates subtle variations of color, making each tee truly  unique. Each tee is screen printed with water based ink which makes the  print</p>
                        <div class="actions">
                            <div class="quantity">
                        ...
                        <div class="product_meta">
                            <span class="sku_wrapper">SKU: <span class="sku">RO-15743</span></span>
                            <span class="posted_in">Category: <a href="shop.html" rel="tag">T-SHIRTS</a></span>
                            <span>Tags: <span><a href="shop.html">ART</a><a href="shop.html">COLORS</a><a href="shop.html">DESIGN</a></span></span>
                        </div>
                    </div>
                </div>
            </div>
