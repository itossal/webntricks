...
<!--==============================
    ...
    <div class="hero-wrapper hero-16" id="hero">
        ...
        <div class="hero-thumb-wrap16">
            ...
            <div class="hero-16-thumb wow img-custom-anim-top jarallax" :data-bg-src="asset('/img/hero/hero-16-1.jpg')">
            </div>
        </div>
    </div>
    <!--======== / Hero Section ========-->
        ...
        <div class="container">
            <div class="row gy-60 gx-60 justify-content-center">                
                <div class="col-lg-5">
                    <a href="project-details.html" class="portfolio-wrap style3">
                        <div class="portfolio-thumb">
                            <img :src="asset('/img/portfolio/portfolio16_1.jpg')" alt="portfolio">
                        </div>
                ...
                <div class="col-lg-7">
                    <a href="project-details.html" class="portfolio-wrap style3">
                        <div class="portfolio-thumb">
                            <img :src="asset('/img/portfolio/portfolio16_2.jpg')" alt="portfolio">
                        </div>
                        <div class="portfolio-details">
                            <ul class="portfolio-meta">
                                <li>Branding</li>
                ...
                <div class="col-lg-7">
                    <a href="project-details.html" class="portfolio-wrap style3">
                        <div class="portfolio-thumb">
                            <img :src="asset('/img/portfolio/portfolio16_3.jpg')" alt="portfolio">
                        </div>
                        <div class="portfolio-details">
                            <ul class="portfolio-meta">
                                <li>Branding</li>
                ...
                <div class="col-lg-5">
                    <a href="project-details.html" class="portfolio-wrap style3">
                        <div class="portfolio-thumb">
                            <img :src="asset('/img/portfolio/portfolio16_4.jpg')" alt="portfolio">
                        </div>
                        <div class="portfolio-details">
                            <ul class="portfolio-meta">
                                <li>Branding</li>
                ...
                <div class="col-lg-5">
                    <a href="project-details.html" class="portfolio-wrap style3">
                        <div class="portfolio-thumb">
                            <img :src="asset('/img/portfolio/portfolio16_5.jpg')" alt="portfolio">
                        </div>
                        <div class="portfolio-details">
                            <ul class="portfolio-meta">
                                <li>Branding</li>
                ...
                <div class="col-lg-7">
                    <a href="project-details.html" class="portfolio-wrap style3">
                        <div class="portfolio-thumb">
                            <img :src="asset('/img/portfolio/portfolio16_6.jpg')" alt="portfolio">
                        </div>
                        <div class="portfolio-details">
                            <ul class="portfolio-meta">
                                <li>Branding</li>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="video-wrap">
                        <div class="jarallax" :data-bg-src="asset('/img/normal/video_16-1.jpg')">
                        </div>
