<!-- Auto-generated from project.html -->
<template>
                ...
                <div class="col-lg-7 filter-item">
                    <div class="portfolio-wrap mt-140">
                        ...
                        <div class="portfolio-details">
                            ...
                            <h3 class="portfolio-title"><a href="project-details.html">Product Lineup Industrial <br> Design for Caramba</a></h3>
                            <a href="project-details.html" class="link-btn">
                                <span class="link-effect">
                                    <span class="effect-1">VIEW PROJECT</span>
                                    <span class="effect-1">VIEW PROJECT</span>
                ...
                <div class="col-lg-5 filter-item">
                    <div class="portfolio-wrap mt-140">
                        ...
                        <div class="portfolio-details">
                            ...
                            <h3 class="portfolio-title"><a href="project-details.html">Trading Website Design & Development</a></h3>
                            <a href="project-details.html" class="link-btn">
                                <span class="link-effect">
                                    <span class="effect-1">VIEW PROJECT</span>
                                    <span class="effect-1">VIEW PROJECT</span>
