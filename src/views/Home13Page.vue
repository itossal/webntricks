<!-- Auto-generated from home-13.html -->
<template>
  <div class="page-content">
<!--==============================
    Hero Area
    ==============================-->
    <div class="hero-wrapper hero-13" id="hero">
        <div class="container">
            ...
            <div class="row gy-4 align-items-center justify-content-center">
                ...
                >
                    <div class="feature-card">
                        ...
                        <p class="feature-card-text">{{ service.description }}</p>
                        <RouterLink :to="`/services/${service.slug}`" class="link-btn">
                            <span class="link-effect">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="blog-card style4">
                        ...
                        <div class="blog-content">
                            <a class="blog-tag" href="blog.html">Branding</a>
